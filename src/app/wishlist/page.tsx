...
export default function WishlistPage() {
  ...
  return (
    <div className="container-x py-12 max-w-4xl">
      ...
      {loading ? (
        <div className="mt-12 text-center text-ivory/60">Loading...</div>
      ) : products.length === 0 ? (
        <div className="mt-12 p-12 text-center border border-taupe/20 bg-blush/20 rounded-lg">
          <div className="text-ivory/70">Nothing saved yet.</div>
          <Link href="/shop" className="btn-primary mt-4 inline-block">Discover the drop</Link>
        </div>
      ) : (
